...
public class AdminMedicationEdit extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (medicationInEdit != null) {
            ...
            importReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                ...
                public void onSuccess(Uri downloadUrl) {
                    Glide.with(AdminMedicationEdit.this)
                            .load(downloadUrl)
                            .dontAnimate()
        ...
        timeTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final TimePickerDialog timePickerDialog =
                        new TimePickerDialog(new ContextThemeWrapper(AdminMedicationEdit.this, R.style.AppTheme2),
        ...
        datesTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(AdminMedicationEdit.this, R.style.AppTheme2));
        ...
        startDateTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AdminMedicationEdit.this,
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (medicationTitleTextView.getText().toString().isEmpty()) {
                    Toast.makeText(AdminMedicationEdit.this, "Enter a medication title", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                ...
                if (datesTextView.getText().toString().equals("Enter dates here.")) {
                    Toast.makeText(AdminMedicationEdit.this, "Select days for medicine consumption", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (medicationStartDate > medicationEndDate) {
                    Toast.makeText(AdminMedicationEdit.this, "End date cannot be before start date", Toast.LENGTH_SHORT).show();
                    return;
                }

                if ((medicationEndDate < currentDate)) {
                    Toast.makeText(AdminMedicationEdit.this, "End date cannot be set before today", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (uri != null) {
                    final ProgressDialog progressDialog = new ProgressDialog(AdminMedicationEdit.this);
                    ...
                    StorageTask<UploadTask.TaskSnapshot> taskSnapshotStorageTask = exportReference.putFile(uri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Toast.makeText(AdminMedicationEdit.this, "File uploaded", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception exception) {
                                    progressDialog.dismiss();
                                    Toast.makeText(AdminMedicationEdit.this, "Upload failed", Toast.LENGTH_SHORT).show();
                                }
